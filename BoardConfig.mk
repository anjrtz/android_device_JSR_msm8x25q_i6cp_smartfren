...
# Kernel
TARGET_PREBUILT_KERNEL := device/JSR/msm8x25q_i6cp_smartfren/kernel
TARGET_KERNEL_SOURCE := kernel/JSR/msm8x25q_i6cp_smartfren
TARGET_KERNEL_CONFIG := cm_msm8x25q_i6cp_smartfren_defconfig
TARGET_BOOTLOADER_BOARD_NAME := qcom
BOARD_KERNEL_CMDLINE := androidboot.hardware=qcom loglevel=1 vmalloc=400M
BOARD_KERNEL_BASE    := 0x00208000
BOARD_KERNEL_PAGESIZE := 4096

TARGET_SPECIFIC_HEADER_PATH := device/JSR/msm8x25q_i6cp_smartfren/include
